...
% Do not edit by hand!
\RCS$Revision: 25638 $
\RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/papers/EWK-10-002/tags/arxiv-0/EWK-10-002.tex $
\RCS$Id: EWK-10-002.tex 25638 2010-12-09 16:31:56Z ghm $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
...
\def\RESSIGBR#1#2#3#4#5#6{  \ensuremath{ \SIGBR{#1}{#2} &=& \RESE{#3}{#4}{#5}{#6} \, \textrm{nb} } }
...
% sigma X BF
\def\WEISIGBR{ \ensuremath{  \RESSIGBR{\PW}{\EN}
                             {10.045}{0.097}{0.517}{1.105} } }  
\def\WEPSIGBR{ \ensuremath{  \RESSIGBR{\PWp}{\EpN}
                             {5.935}{0.074}{0.359}{0.653} } } 
\def\WEMSIGBR{ \ensuremath{  \RESSIGBR{\PWm}{\EmN}
                             {4.140}{0.064}{0.254}{0.455} } } 

% restricted cross sections

\def\WEISIGBRX{\ensuremath{ \RESSIGBR{\PW}{\EN}
                             {6.037}{0.058}{0.307}{0.664} } }
\def\WEPSIGBRX{\ensuremath{ \RESSIGBR{\PWp}{\EpN}
                             {3.688}{0.046}{0.220}{0.406} } }
\def\WEMSIGBRX{\ensuremath{ \RESSIGBR{\PWm}{\EmN}
                             {2.363}{0.036}{0.140}{0.260} } }
\def\ZEESIGBRX{\ensuremath{ \RESSIGBR{\PZ}{\EE}
...
\def\ZEESIGBR{ \ensuremath{  \RESSIGBR{Z}{e^+e^-}
...
\def\RESRATWZE{ \ensuremath{ \RESRATWZ{e\nu}{e^+e^-}{10.468}{0.416}{0.468} } }
\def\RESRATWWE{ \ensuremath{ \RESRATWW{e^+\nu}{e^-\bar{\nu}}{1.434}{0.028}{0.082} }}
...
% cross sections
\def\WMISIGBR{\ensuremath{ \RESSIGBR{W}{\mu\nu}
                             {9.922}{0.090}{0.307}{1.091}} }
\def\WMPSIGBR{\ensuremath{ \RESSIGBR{W^+}{\mu^+\nu}
                             {5.844}{0.069}{0.176}{0.643} } }
\def\WMMSIGBR{\ensuremath{ \RESSIGBR{W^-}{\mu^-\bar{\nu}}
                             {4.078}{0.057}{0.147}{0.449} } }
\def\ZMMSIGBR{\ensuremath{ \RESSIGBR{Z}{\mu^+\mu^-}
                             {0.924}{0.031}{0.022}{0.102} } }

% restricted cross sections
\def\WMISIGBRX{\ensuremath{ \RESSIGBR{W}{\mu\nu}
                             {5.212}{0.047}{0.150}{0.573} } }
\def\WMPSIGBRX{\ensuremath{ \RESSIGBR{W^+}{\mu^+\nu}
                             {3.163}{0.037}{0.099}{0.348} } }
\def\WMMSIGBRX{\ensuremath{ \RESSIGBR{W^-}{\mu^-\bar{\nu}}
                             {2.048}{0.029}{0.063}{0.225} } }
\def\ZMMSIGBRX{\ensuremath{ \RESSIGBR{Z}{\mu^+\mu^-}
                             {0.368}{0.012}{0.007}{0.040} } }

% ratios
\def\RESRATWZM{\ensuremath{ \RESRATWZ{\mu\nu}{\mu^+\mu^-}{10.738}{0.368}{0.326} }}
\def\RESRATWWM{\ensuremath{ \RESRATWW{\mu^+\nu}{\mu^-\bar{\nu}}{1.433}{0.026}{0.054} }}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% combined results
\def\WLISIGBR{\ensuremath{ \RESSIGBR{W}{\ell\nu}
                             {9.951}{0.073}{0.280}{1.095} } }
\def\WLPSIGBR{\ensuremath{ \RESSIGBR{W^+}{\ell^+\nu}
                             {5.859}{0.059}{0.168}{0.645} } }
\def\WLMSIGBR{\ensuremath{ \RESSIGBR{W^-}{\ell^-\bar{\nu}}
                             {4.092}{0.046}{0.136}{0.450} } }
\def\ZLLSIGBR{\ensuremath{ \RESSIGBR{Z}{\ell^+\ell^-}
                             {0.931}{0.026}{0.023}{0.102} } }

\def\RESRATWZL{ \ensuremath{ \RESRATWZ{\ell\nu}{\ell^+\ell^-}{10.638}{0.278}{0.291} }}
...
\def\THGHMRATIOWW{\ensuremath{ \RESD{1.435}{0.044} }}
...
\newcommand{\MN}{\ensuremath{\Pgm\Pgngm}}%
\newcommand{\MpN}{\ensuremath{\Pgmp\Pgngm}}%
\newcommand{\MmN}{\ensuremath{\Pgmm\Pagngm}}%
\newcommand{\EN}{\ensuremath{\Pe\Pgne}}%
\newcommand{\EpN}{\ensuremath{\Pep\Pgne}}%
\newcommand{\EmN}{\ensuremath{\Pem\Pagne}}%
\newcommand{\TN}{\ensuremath{\Pgt\Pgngt}}%
\newcommand{\TpN}{\ensuremath{\Pgt^+\Pgngt}}%
\newcommand{\TmN}{\ensuremath{\Pgt^-\Pagngt}}%
...
\newcommand{\Wpmn}{\ensuremath{\PWp \ra \Pgmp\Pgngm}}%
\newcommand{\Wmmn}{\ensuremath{\PWm \ra \Pgmm\Pagngm}}%
\newcommand{\Zmm}{\ensuremath{\PZ \ra \MM}}%
\newcommand{\Wtn}{\ensuremath{\PW \ra \Pgt\Pgngt}}%
\newcommand{\Ztt}{\ensuremath{\PZ \ra \TT}}%
\newcommand{\ppZmm}{\pp \ra \PZ + X \ra \MM + X}%
...
\newcommand{\gammaZmm}{\mbox{$ \gammaZ\rightarrow \MM$}}
\newcommand{\gammaZee}{\mbox{$ \gammaZ\rightarrow \EpEm$}}
\newcommand{\gammaZtt}{\mbox{$ \gammaZ\rightarrow \TT$}}
...
momentum ($\pt$) resolution of better than 1\% for charged particles 
with $\pt$ above $40\GeV$.
\par
...
bremsstrahlung in the tracker layers.  Particles misidentified as
...
distributions for $W\rightarrow\ell\nu$ events from data and from
...
$W\rightarrow\ell\nu$ events is reproduced well by the 
...
\hline
\hline
\multirow{3}{*}{$\PW$} & $\Pe\nu$ & \WEISIGBRGHM & \multirow{3}{*}{\THGHMSIGBRWI} \\
                  & $\Pgm\nu$ & \WMISIGBRGHM & \\
                  & $\ell\nu$ & \WLISIGBRGHM & \\
\hline \hline
\multirow{3}{*}{$\PWp$} & $\Pep\nu$ & \WEPSIGBRGHM & \multirow{3}{*}{\THGHMSIGBRWP} \\
                  & $\Pgmp\nu$ & \WMPSIGBRGHM & \\
                  & $\ell^+\nu$ & \WLPSIGBRGHM & \\
\hline \hline
\multirow{3}{*}{$\PWm$} & $\Pem\bar{\nu}$ & \WEMSIGBRGHM & \multirow{3}{*}{\THGHMSIGBRWM} \\
                  & $\Pgmm\bar{\nu}$ & \WMMSIGBRGHM & \\
                  & $\ell^-\bar{\nu}$ & \WLMSIGBRGHM & \\
\hline \hline
