...
% Do not edit by hand!
\RCS$Revision: 71603 $
\RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/papers/EWK-10-005/tags/arxiv-0/EWK-10-005.tex $
\RCS$Id: EWK-10-005.tex 71603 2011-07-24 20:16:11Z alverson $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
...
10.30 \pm 0.02 ~\mathrm{(stat.)} \pm 0.10 ~\mathrm{(syst.)} \pm 0.10 ~\mathrm{(th.)} \pm 0.41 ~\mathrm{(lumi.)}$~nb
and
