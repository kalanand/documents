...
TCanvas* plotting36GN( bool logScale=false ) 
{

  std::cout << "plotting mumu non iso " << std::endl;
...

  {
    ...
    cname += "ZmumuNoIso";
    ctitle = "Z mumu non iso analysis";
  ...
  if( logScale ) cname += "NoIso_log";
  else           cname += "NoIsoNotInThePAPER_lin";
  ...
  //lumi pad, cms prelim pad etc..
  {
    ...
    latex.DrawLatex(txtX3,txtY3,"non isolated dimuons");
  }
