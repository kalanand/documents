...
## Notes:
##
## a) For 36 inverse pb statistics, all likelihood profiles are already 
...
Wenu = 10.4760
absStatWenu = 0.0296
absCorrWenu = 0.89e-2*Wenu # theory uncertainty
absUncWenu = 0.1508
...
Wplusenu = 6.1481
absStatWplusenu = 0.0224
absCorrWplusenu = 1.24e-2*Wplusenu # theory uncertainty
absUncWplusenu = 0.0972
...
Wminusenu = 4.3352
absStatWminusenu = 0.0195
absCorrWminusenu = 1.38e-2*Wminusenu # theory uncertainty
absUncWminusenu = 0.0705
...
Zee = 0.98509/0.993
absStatZee = 0.0108/0.993
absCorrZee = 1.63e-2*Zee # theory uncertainty
absUncZee = 0.0182/0.993
...
absStatRatioenu = 0.0082
absCorrRatioenu = 2.02e-2*Ratioenu # theory uncertainty
absUncRatioenu = 0.02158
...
WZe = Wenu/Zee
absStatWZe = 0.1192
absCorrWZe = 1.37e-2*WZe # theory uncertainty
absUncWZe = 0.1231
...
# Muon inputs 
Wmunu = 10.113/0.993
absStatWmunu = 0.026/0.993
absCorrWmunu = Wmunu*1.08e-2 # theory uncertainty
relUncFit = 0
relUncSysEff = 0.9e-2
relUncPreTrig = 0.5e-2
relUncEff = sqrt(relUncFit**2+relUncPreTrig**2+relUncSysEff**2)
relUncMomRes = 0.22e-2
relUncRecoil = 0.2e-2
relUncMCStat = 0;
relUncBkg = 0.4e-2
...
Wplusmunu = 5.940/0.993
absStatWplusmunu = 0.020/0.993
absCorrWplusmunu = Wplusmunu*1.3e-2 # theory uncertainty
relUncFit = 0
relUncPreTrig = 0.5e-2
relUncSysEff = 0.9e-2
relUncEff = sqrt(relUncFit**2+relUncPreTrig**2+relUncSysEff**2)
relUncMomRes = 0.19e-2
relUncRecoil = 0.2e-2
relUncMCStat = 0
relUncBkg = 0.4e-2 #sqrt(1.7e-2**2+0.2e-2**2)
...
Wminusmunu = 4.173/0.993
absStatWminusmunu = 0.01758/0.993
absCorrWminusmunu = Wminusmunu*1.7e-2 # theory uncertainty
relUncFit = 0
relUncPreTrig = 0.5e-2
relUncSysEff = 0.9e-2
relUncEff = sqrt(relUncFit**2+relUncPreTrig**2+relUncSysEff**2)
relUncMomRes = 0.25e-2
relUncRecoil = 0.2e-2
relUncMCStat = 0
relUncBkg = 0.5e-2 #sqrt(2.3e-2**2+0.2e-2**2)
...
Zmumu = 0.961/0.993 # 0.893*1.025*1.01
absStatZmumu = 0.008/0.993 # 0.030*1.025*1.01
absCorrZmumu = Zmumu*1.9e-2 # theory uncertainty
...
absStatRatiomunu = 0.0077
absCorrRatiomunu = Ratiomunu*2.1e-2 # theory uncertainty
relUncEff = 1.3e-2
relUncMomRes = 0.06e-2
relUncMCStat = 0
relUncBkg = 0.2e-2
...
absCorrWZmu = WZmu*1.6e-2 # theory uncertainty
relUncEffW = 0.9e-2
relUncMomResW = 0.22e-2
relUncMomResZ = 0.35e-2
relUncETscale = 0.2e-2
relUncBkg = 0.4e-2
relSysSubtract = sqrt(relUncEffW**2+relUncMomResW**2+relUncMomResZ**2+relUncETscale**2)
relSysAdd = abs(relUncMomResW-relUncMomResZ)
absUncWZmu = WZmu*sqrt((absUncWmunu/Wmunu)**2 + (absUncZmumu/Zmumu)**2 - relSysSubtract**2 + relSysAdd**2 + relUncBkg**2)
