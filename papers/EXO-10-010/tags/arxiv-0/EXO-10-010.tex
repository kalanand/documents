...
% trivial test change
\RCS$Revision: 17815 $
\RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/papers/EXO-10-010/tags/arxiv-0/EXO-10-010.tex $
\RCS$Id: EXO-10-010.tex 17815 2010-09-30 17:21:58Z rharris $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
...
by the CMS experiment at the LHC. Upper limits at the 95\% confidence level (CL) are presented on the product of the resonance cross 
...
95\% CL: string resonances, with mass less than 2.50~TeV, excited quarks, with mass less than 1.58~TeV, 
...
previous exclusion of $0.12<M(A)<1.25$~TeV~\cite{refCDFrun2}. For $\mbox{E}_6$ diquarks the expected 
mass limit is $1.05$~TeV, and we exclude the mass
intervals $0.50<M(D)<0.58$~TeV, and $0.97 < M(D) < 1.08$~TeV, and $1.45 < M(D) < 1.60$~TeV, 
extending the previous exclusion of $0.29<M(D)<0.63$~TeV~\cite{refCDFrun2}.
