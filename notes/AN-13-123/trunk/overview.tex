...
detailed study of the tagjet pair invariant mass $m_{jj}$ of the major backgrounds,
which is covered in more detail in Sections~\ref{sec:mjj_fit}. 
%Once these shapes have been optimally
%determined the total yields are fed into the cross-section calculation
%(Section~\ref{sec:mjj_fit}).
