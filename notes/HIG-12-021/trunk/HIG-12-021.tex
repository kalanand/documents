...
% Do not edit by hand!
\RCS$Revision: 134665 $
\RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/notes/HIG-12-021/trunk/HIG-12-021.tex $
\RCS$Id: HIG-12-021.tex 134665 2012-07-03 23:02:58Z kalanand $
%%%%%%%%%%%%% local definitions %%%%%%%%%%%%%%%%%%%%%
...
sample corresponding to an integrated luminosity of 5.1~fb$^{-1}$ of
...
angular spin correlations between the decay products.  No evidence for the
Higgs boson is found.  Using 8~TeV data, we exclude the Standard Model
Higgs boson in the mass range 260--460~GeV at 95\% confidence level. 
When combined with 7~TeV data, the exclusion range expands to
230-480~GeV at 95\% confidence level.}
...
pdftitle={Search for the Standard Model Higgs boson in the H WW lnujj decay channel in pp collisions at sqrt s =8 TeV},%
pdfsubject={CMS},%
...
mechanism of electroweak symmetry breaking where the W and Z bosons 
acquire mass while the
...
with part of this range already excluded by direct searches from the 
...
luminosity of $5.1 \pm 0.3\fbinv$ collected with the CMS detector in
...
For this analysis, samples with Higgs mass hypotheses ranging
...
optimized for Higgs mass hypotheses of 200\GeVnn, 300\GeVnn, and 500\GeVnn. 
...
\begin{figure}[!t]
  ...
  signal region for the Higgs mass hypothesis of 200\GeVnn (a), 
  300\GeVnn (b), and 500\GeVnn (c),
  for muon plus 2-jets category. 
...
by using a control sample in data. 
...
We exclude at 95\% confidence level the SM Higgs boson in the mass range
$260-460\GeVnn$ from analyzing 8 TeV data.  Combining with 7 TeV
results~\cite{HIG-12-003}, we exclude the SM Higgs boson in
the mass range $230-480\GeVnn$, at 95\% confidence level.
...
integrated luminosity of 5.1\fbinv at $\sqrt{s}=8\TeV$ recorded by the 
CMS experiment at the LHC.  
No evidence for the SM-like Higgs boson is found  
...
the mass range $260-460$~GeV at 95\% confidence level. 
When combined with 7~TeV data, the exclusion range
expands to $230-480$~GeV at 95\% confidence level.
