...
% Do not edit by hand!
\RCS$Revision: 223161 $
\RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/notes/AN-12-464/trunk/AN-12-464.tex $
\RCS$Id: AN-12-464.tex 223161 2014-01-14 23:56:54Z ilyao $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
...
%==============================================================================
%%%%%%%%%%%%%%%  Title page %%%%%%%%%%%%%%%%%%%%%%%%
\cmsNoteHeader{AN-12-464} % This is over-written in the CMS environment: useful as preprint no. for export versions
...
\address[ku]{University of Kansas, Lawrence, Kansas, USA}
...
\author[uerj]{Analu~Vercosa~Custodio}
...
\abstract{
We present a measurement of the sum of WW and WZ production 
with W+dijet events in pp collisions at $\sqrt{s} = 8$~TeV. 
The analyzed dataset corresponds to an integrated luminosity 
of 19~fb${}^{-1}$ collected by the CMS detector at the Large Hadron Collider.
With the kinematic requirements imposed in the analysis, we 
observe 9234 $\pm$ 532 (stat) $\pm$ 917 (syst) WW+WZ events, 
in agreement with the Standard Model expectation. 
The measured value of the sum of WW and WZ cross sections is 
$126.2 \pm 7.8\text{(stat)} \pm 13.9\text{(syst)} \pm 3.3\text{(lumi)}$~pb, consistent 
