...
% Do not edit by hand!
\RCS$Revision: 160629 $
\RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/notes/AN-12-465/trunk/AN-12-465.tex $
\RCS$Id: AN-12-465.tex 160629 2012-12-08 18:51:49Z alverson $
%%%%%%%%%%%%% local definitions %%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%  Title page %%%%%%%%%%%%%%%%%%%%%%%%
\cmsNoteHeader{AN-12-465} % This is over-written in the CMS environment: useful as preprint no. for export versions
% >> Title: please make sure that the non-TeX equivalent is in PDFTitle below
\title{Search for a Higgs Boson in qqH-> W[lnu] W[jj] + 2 Tag Jets at \sqrts = 8 TeV}
...
pdftitle={Search for a Higgs Boson in qqH-> W[lnu] W[jj] + 2 Tag Jets at sqrts = 8 TeV},%
pdfsubject={CMS},%
