...
% Do not edit by hand!
\RCS$Revision: 152329 $
\RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/notes/AN-11-151/trunk/AN-11-151.tex $
\RCS$Id: AN-11-151.tex 152329 2012-10-12 00:55:56Z dudero $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
...
%==============================================================================
%%%%%%%%%%%%%%%  Title page %%%%%%%%%%%%%%%%%%%%%%%%
\cmsNoteHeader{AN-12-224} % This is over-written in the CMS environment: useful as preprint no. for export versions
% >> Title: please make sure that the non-TeX equivalent is in PDFTitle below
\title{Measurement of WW+WZ cross section in semi-leptonic decays in pp 
...
\abstract{
We present a study of the Standard Model electroweak production 
of two gauge bosons  in events 
...
%%We observe a resonance peak in the dijet invariant mass distribution
%%with its mean consistent with the W or 
%%Z boson mass and width consistent with the jet resolution. 
...
$68.9 \pm 8.7 \text{(stat)} \pm 9.7 \text{(syst)}  \pm 1.5 \text{(lumi)}$~pb, consistent 
with the standard model prediction of $65.6 \pm 2.2$~pb. 
...
pdftitle={Study of diboson WW, WZ production using lnu jj events in pp 
...
\appendix
\clearpage
\input{app_ATGC_j1t1pt}
\clearpage
\input{app_ATGC_leptonpt}
\clearpage
\input{app_ATGC_leptonicWpt}
\clearpage
\input{app_ATGC_mWW}
\clearpage
\input{app_fMUfSUCrosschecks}
\clearpage
\input{app_ATGC_parametrization}
\clearpage
\input{app_ATGC_largemjjwin}
