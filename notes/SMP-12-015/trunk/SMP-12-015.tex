...
% Do not edit by hand!
\RCS$Revision: 123573 $
\RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/notes/SMP-12-015/trunk/SMP-12-015.tex $
\RCS$Id: SMP-12-015.tex 123573 2012-05-22 23:50:24Z kalanand $
%%%%%%%%%%%%% local definitions %%%%%%%%%%%%%%%%%%%%%
...
$61.4 \pm 12.0$ (stat and syst) pb, consistent 
...
\caption{(a) Distribution of the invariant mass spectrum of the
    two jets in data. Overlaid are the fit
    projections of the various components. Depicted is the
    number of events per GeV, \textit{i.e.}, the raw event count can
    ...
    statistical uncertainty.  The band represents the systematic
    uncertainty in the sum of the SM components.  (c) The normalized
...
\hline
        Dibosons        &   1736 $\pm$ 389       &  226 $\pm$ 203   &  727 $\pm$ 302   &   35 $\pm$ 86 \\
        Multijet        &   119 $\pm$ 317        &  16 $\pm$ 42     & 3204 $\pm$ 867   &  231 $\pm$ 78 \\
        ...
        Drell-Yan plus jets &   3613 $\pm$ 155   &  206 $\pm$ 9     &  1485 $\pm$ 64   &  858 $\pm$ 37 \\
\hline
...
diboson yield is below xx\% and that the fit understimates the yield
...
Theoretical uncertainty in acceptance computation is 3\%. 
...
$\sigma = 61.39 \pm 11.98$~pb, which is in agreement with 
the NLO prediction~\cite{Campbell:2011bn} $65.6 \pm 2.2$~pb.
...
$ -0.092 < \Lambda_Z < 0.072$, $ -0.312 < \Delta{\kappa_\gamma} < 0.358$.
%%The corresponding expected exclusion limits are
%%$ -0.105 < \Lambda_Z  < 0.101$, $ -0.396 < \Delta{\kappa_\gamma} < 0.450$.
%%These limits are consistent with the SM prediction. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[tbh]
  {\centering
    \includegraphics[width=0.4\textwidth]{figs/atgc_dijetPt.png}
    \includegraphics[width=0.4\textwidth]{figs/atgc_limits_noshape_contours_dijetptmin200gev.png}
    \caption{FIXME: NEED TO UPDATE THE PLOTS.
    (a) Dijet $p_T$ distribution (all categories) after requiring 
    $75~\GeVnn < \mjj < 95~\GeVnn$ (b)
 The observed and expected values of the CL${}_{\textrm{S}}$ statistic for 
anomalous triple gauge couplings shown as 2-dimensional contour in $\Lambda_Z:\Delta{\kappa_\gamma}$ plane.
    }
    \label{fig:Fig2}}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
