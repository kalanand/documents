...
% Do not edit by hand!
\RCS$Revision: 112861 $
\RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/notes/AN-11-266/trunk/AN-11-266.tex $
\RCS$Id: AN-11-266.tex 112861 2012-03-28 22:47:04Z kalanand $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
...
%==============================================================================
%%%%%%%%%%%%%%%  Title page %%%%%%%%%%%%%%%%%%%%%%%%
\cmsNoteHeader{AN-11-266} % This is over-written in the CMS environment: useful as preprint no. for export versions
...
\address[wisc]{University of Wisconsin, Madison, Wisconsin, USA}
\address[tamu]{Texas A\&M University, College Station, Texas, USA}
\address[knu]{Texas A\&M University, College Station, Texas, USA and Kyungpook National University, Daegu, South Korea}
\address[nebr]{University of Nebraska at Lincoln, Nebraska, USA}
\address[punj]{Panjab University, Chandigarh, India}
...
\author[wisc]{Maria~Cepeda}
\author[wisc]{Sridhara~Dasu}
\author[ttu]{Phil~Dudero}
\author[wisc]{Jonathan~Efron}
\author[tamu]{Ricardo~Eusebi}
\author[fnal]{Dan~Green}
\author[wisc]{Monika~Grothe}
\author[nebr]{Pratima~Jindal}
\author[knu]{Teruki~Kamon}
\author[ttu]{Sung-Won Lee}
\author[fnal]{Kalanand~Mishra}
\author[wisc]{Isabel~Ojalvo}
\author[tamu]{Ilya~Osipenkov}
\author[tamu]{Alexx~Perloff}
\author[punj]{Lovedeep~Kaur~Saini}
\author[tamu]{Tai~Sakuma}
\author[punj]{Anil~Singh}
...
\abstract{
We present a study of the dijet invariant mass spectrum in events 
with two or three jets produced in association with a W boson in data 
...
We find no evidence for anomalous resonant dijet production with 
mass around 150~GeV and derive upper limits on its production cross 
...
\hypersetup{%
pdfauthor={Jake Anderson, Phil Dudero, Jonathan Efron, Monika Grothe,
Pratima Jindal, Kalanand Mishra, Ilya Osipenkov, Alexx Perloff, Tai Sakuma, Fan
Yang},%
pdftitle={Study of the dijet invariant mass distribution in pp rightarrow W (rightarrow l nu) + jj final states at sqrts = 7 TeV},%
pdfsubject={CMS},%
...
\input{LeptonicW}
\clearpage
%\section{Basic kinematic distributions of jets in events with NJets $\ge 2$ \label{sec:JetKinematics}}
%\input{JetKinematics}
%\section{Dijet mass distribution\label{sec:mjj}}
%\input{mjj}
\input{SignalExtraction}
\clearpage
\input{NewPhysics}
\clearpage
\input{Systematics}
...
\clearpage
\appendix
\input{appendixJECscan}
\clearpage
\input{CutsAndFitterConfigurations}
\clearpage
\input{WjetsMjj}
\clearpage
\input{appendixMCstatistics}
\clearpage
\input{appendixQCDinMC}
\clearpage
\input{appendixQCDwithWmT}
\clearpage
\input{ElectronJetPtStudy}
\clearpage
\input{TriggerJetPtStudy}
\clearpage
\input{OptimizationThenFitValidation}
\clearpage
\input{PileUpEpochComparison}
\clearpage
\input{IsolationComparison}
\clearpage
\input{ExclusionRangeComparison}
%%\clearpage
%%\input{appendixMoreLimits.tex}  
