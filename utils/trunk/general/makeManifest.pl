...
my $VERSION = sprintf "%d.%03d", q$Revision: 216810 $ =~ /(\d+)/g;
my $verbose;
...
#
   ...
   # \RCS$Revision: 216810 $
   # \RCS$Date: 2013-11-17 16:59:35 -0600 (Sun, 17 Nov 2013) $
   # \RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/utils/trunk/general/makeManifest.pl $
   # \RCS$Id: makeManifest.pl 216810 2013-11-17 22:59:35Z alverson $
   ...
   if ($checkRefs)
   {
       ...
       else 
       {
           ...
           {
               print ">> tdr (makeManifest): trying /usr/bin/python26 (default location on lxplus)\n";
